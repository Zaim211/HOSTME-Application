...
export default function ImagesUploder({ addedPhotos, onChange }) {
  ...
  return (
    <>
      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <label className="h-32 cursor-pointer flex items-center gap-1 justify-center border bg-transparent rounded-2xl p-4 text-2xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
